        ...
        <div className='sidebar d-flex justify-content-between flex-column bg-dark text-white py-3 ps-3 pe-3 vh-100'>
            <div>
                ...
                <ul className='nav nav-pills flex-column mt-2'>
                    ...
                    <Link to="/reserva" className='p-1 text-decoration-none text-white' >
                    ...
                    <Link to="/sala" className='p-1 text-decoration-none text-white' >
            ...
            <div>
                ...
                <div className='nav-item p-2'>
                    <Link className='p-1 text-decoration-none text-white' to="/perfil">
